...
func New(
	...
	r.Route("/api", func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.Get("/seals/{sealID}/projects", sealHandler.ListProjects)
			r.Post("/seals/{sealID}/projects", sealHandler.CreateProject)
			r.Post("/seals/{sealID}/projects/{projectID}/refresh", sealHandler.RefreshProject)
			r.Delete("/seals/{sealID}/projects/{projectID}", sealHandler.DeleteProject)
			r.Get("/seals/{sealID}/projects/{projectID}/services", sealHandler.ListProjectServices)
			r.Post("/seals/{sealID}/projects/{projectID}/services", sealHandler.CreateProjectService)
			r.Get("/seals/{sealID}/projects/{projectID}/services/{serviceID}/routes", sealHandler.ListProjectServiceRoutes)
			r.Post("/seals/{sealID}/projects/{projectID}/services/{serviceID}/routes", sealHandler.CreateProjectServiceRoute)
			r.Delete("/seals/{sealID}/projects/{projectID}/services/{serviceID}/routes/{routeID}", sealHandler.DeleteProjectServiceRoute)
			r.Get("/seals/{sealID}/projects/{projectID}/configuration", sealHandler.ProjectConfiguration)
